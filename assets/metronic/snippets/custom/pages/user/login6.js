var SnippetLogin=function(){
	$("#m_login");
	var t=function(){
		$("#m_login_signin_submit").click(function(t){t.preventDefault();
			var e=$(this),
			a=$(".m-login__form");
			a.validate({
				...
				success:function(t,i,n,r){
					setTimeout(function(){
						...
						function(t,e,a){
							...
							i.find("span").html(a)}(a,"danger","Incorrect username or password. Please try again.")},2e3)}}))}
			)};
		return{init:function(){t()}}}();jQuery(document).ready(function(){SnippetLogin.init()});